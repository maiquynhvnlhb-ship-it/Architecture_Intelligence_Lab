...
def Quan_Xe():
    ...
    def draw_board(master, cell_size=(9, 4)):
        ...
        tk.Label(master, text="MÔ TẢ HILL CLIMBING", font=("Arial", 15, "bold"),
    ...
    def restart():
        ...
        start = random_start()
        all_logs = hill_climbing(start, goal)
        current_step = 0
        paused = False
        move(0)
    ...
    game.title("8 Quân Xe - Hill Climbing")
