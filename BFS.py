...
# ================== BFS ==================
def BFS(goal):
    """Trả về tất cả các bước BFS (state)"""
    def check(vt, col):
        row = len(vt)
        for r, c in vt:
            if c == col:
...
def Quan_Xe():
    def draw_board(master, cell_size=(9, 4)):
        ...
        tk.Label(master, text="MÔ TẢ BFS TRONG BÀI TOÁN", font=("Arial", 15, "bold"),
    ...
    game.title("8 Quân Xe - BFS (tọa độ 2D)")
